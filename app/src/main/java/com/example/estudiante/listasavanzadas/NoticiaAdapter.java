...
//Generar un rengón por objeto
    @Override
    public View getView(final int position, View view, ViewGroup viewGroup) {

        //Pasa de xml (txt) a una vista (algo que entiende android
        ...
        item_action.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // noticias.remove(position);
                ...
                //Si fuera desde la MainActivity
                //Intent i= new Intent(MainActivity.this, NoticiaCompleta.class);
                //startActivity(i);
            }
        });
